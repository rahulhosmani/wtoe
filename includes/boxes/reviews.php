...
// display random review box
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr><td class="name_padd"><br />'.$name_prod.'</td></tr>
...
// display 'write a review' box
   ...
   $info_box_contents[] = array('text' => '
	...
	<table border="0" cellspacing="0" cellpadding="0">
		<tr><td align="center"><a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . tep_image(DIR_WS_IMAGES . 'box_write_review.gif', IMAGE_BUTTON_WRITE_REVIEW) . '</a></td></tr>
		<tr><td style="width:100%;padding:0px 0px 0px 10px;"><a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . BOX_REVIEWS_WRITE_REVIEW .'</a></td>
		</tr>
	</table>
	');
