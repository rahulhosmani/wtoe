...
if ($count ==0 ) $kk=' class="bg_list2_un"'; else $kk=' class="bg_list2"'; 
		...
		$count ++;
	   	...
	   	if ($count != 0 ){
   			...
   			$bestsellers_list .= '<li'.$kk.' id="li_id" onMouseOut="this.id=\'li_id\';" onMouseOver="this.id=\'over_li_id\';"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '"><b>' . $separ . $count . '.&nbsp;&nbsp;</b><font>' . $best_sellers['products_name'] . '</font></a></li>';
			
				
		
		} else {
   
   			$bestsellers_list .= '<li'.$kk.' id="li_id" onMouseOut="this.id=\'li_id\';" onMouseOver="this.id=\'over_li_id\';"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '"><b>&nbsp;&nbsp;' . $count . '.&nbsp;</b><font>' . $best_sellers['products_name'] . '</font></a></li>';
