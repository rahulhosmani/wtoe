...
// ************************ class infoBoxHeading  
  class infoBoxHeading extends tableBox {
    function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents[] = array(array('params' => ' class="infoBoxHeading_b"',
                                         	'text' => '
					...
					<table cellpadding="0" cellspacing="0" border="0" class="infoBoxHeading_tl">
						<tr><td class="infoBoxHeading_tr">
							<table cellpadding="0" cellspacing="0" border="0" class="infoBoxHeading_bl">
								<tr><td class="infoBoxHeading_td infoBoxHeading_br">'.$contents[0]['text'].'</td></tr>
							</table>
						</td></tr>
					</table>
				</td></tr>
...
// ************************ class infoBox3  
  class infoBox3 extends tableBox {
    function infoBox3($contents) {
      ...
      $info_box_contents[] = array('text' => $this->infoBoxContents($contents));
      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="infoBox3_table" align="right"';
...
// ************************ class infoBox4  
  class infoBox4 extends tableBox {
    function infoBox4($contents) {
      ...
      $info_box_contents[] = array('text' => $this->infoBoxContents($contents));
      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="infoBox4_table"';
      $this->table_data_parameters = ' class="infoBox4_td"';	  
      $this->tableBox($info_box_contents, true);
    }
    function infoBoxContents($contents) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="infoBoxContents4_table"';
      $info_box_contents = array();
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {	  
      $info_box_contents[] = array(array('align' => (isset($contents[$i]['align']) ? $contents[$i]['align'] : ''),
										 	'form' => (isset($contents[$i]['form']) ? $contents[$i]['form'] : ''),
...
// **********************************************************************************************
// ************************ class infoBoxHeadingTitle
  class infoBoxHeadingTitle extends tableBox {
    function infoBoxHeadingTitle($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      $this->table_cellpadding = '0';
      $this->table_parameters = ' class="infoBoxHeadingTitle_table"';	  
      ...
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => ' class="infoBoxHeadingTitle_td"',
                                         	'text' => ''.$contents[0]['text'].''));
      $this->tableBox($info_box_contents, true);
    }
  }
...
// **********************************************************************************************
  ...
  { return $table = '<div style="padding:14px 0px 0px 0px;">'.tep_draw_separator('spacer.gif', '1', '1').'</div>';}
// **********************************************************************************************
...
// **********************************************************************************************
  ...
  { return $table = '<div style="padding:0px 0px 0px 0px;">'.tep_draw_separator('spacer.gif', '1', '1').'</div>';}
// **********************************************************************************************
// **********************************************************************************************
...
// class constructor
    function tableBox_output2($contents, $direct_output = false) {
      $tableBox_string = '<table border="' . tep_output_string($this->table_border) . '" width="' . tep_output_string($this->table_width) . '" cellspacing="' . tep_output_string($this->table_cellspacing) . '" cellpadding="' . tep_output_string($this->table_cellpadding) . '"';
      if (tep_not_null($this->table_parameters)) $tableBox_string .= '' . $this->table_parameters;
      $tableBox_string .= '>' . "\n";
      for ($i=0, $n=sizeof($contents); $i<$n; $i++) {
		...
		if ($i != 0) 
		{ 
		$tableBox_string.='<tr><td class="padd3_gg cart_line_x" colspan="'.(($x+$x)-1).'">'.tep_draw_separator('spacer.gif', '1', '1').'</td></tr>';
		} 
		$tableBox_string .= '   <tr';
        if (tep_not_null($this->table_row_parameters)) $tableBox_string .= ' ' . $this->table_row_parameters;
        if (isset($contents[$i]['params']) && tep_not_null($contents[$i]['params'])) $tableBox_string .= ' ' . $contents[$i]['params'];
...
// **********************************************************************************************
// ************************ class tableBox_output2
  class contentBox2 extends tableBox_output2 {
    function contentBox2($contents) {
      $info_box_contents = array();
      $info_box_contents[] = array('text' => $this->contentBoxContents($contents));
      $this->table_cellpadding = '0';
      $this->table_parameters = '';
      $this->table_data_parameters = ' class="tableBox_output2_td main"';	  
      $this->tableBox_output2($info_box_contents, true);
    }

    function contentBoxContents($contents) {
      $this->table_cellpadding = '0';
      $this->table_parameters = '';
      return $this->tableBox_output2($contents);
    }
  }
// **********************************************************************************************
